...
class MyString{
  ...
  public:
    ...
    MyString(const MyString & o_str);				    //(3)
    ~MyString();							    //(4)
    ...
    bool operator== (const MyString & o_str) const;	            //(8)
    MyString & operator= (const MyString & o_str);		            //(9)
    MyString operator+ (const MyString & o_str) const;	            //(10)
